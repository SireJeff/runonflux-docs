...
<img src="/.gitbook/assets/Interactive Terminal 1.png" alt=""/>

<img src="/.gitbook/assets/Interactive Terminal 2.png" alt=""/>
...
The Volume Browser displays the contents of your container's filesystem starting at the root `/`. For each file or folder, you’ll see:
